...
export const CITY_COORDS = {
  ...
  'Jaffa':              [32.0511, 34.7501],
  'Rosh Pinna':         [32.9644, 35.5439],
  'Safed':              [32.9646, 35.4960],
  'Ein Hod':            [32.7000, 34.9667],
  "Beit She'an":        [32.5024, 35.4967],
}
