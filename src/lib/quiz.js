...
export function getPlanFitSummary(plan, answers, lang) {
  ...
  const cityText = {
    'Jerusalem':       { en: 'in Jerusalem',      he: 'בירושלים' },
    'Tel Aviv':        { en: 'in Tel Aviv',       he: 'בתל אביב' },
    "Modi'in":         { en: "in Modi'in",        he: 'במודיעין' },
    'Beit Shemesh':    { en: 'in Beit Shemesh',   he: 'בבית שמש' },
    'Tzur Hadassah':   { en: 'in Tzur Hadassah',  he: 'בצור הדסה' },
    'Haifa':           { en: 'in Haifa',          he: 'בחיפה' },
    'Herzliya':        { en: 'in Herzliya',       he: 'בהרצליה' },
    "Ra'anana":        { en: "near Ra'anana",       he: 'ברעננה' },
    'Netanya':         { en: 'in Netanya',        he: 'בנתניה' },
    'Petach Tikva':     { en: 'in Petach Tikva',    he: 'בפתח תקווה' },
    'Givat Shmuel':    { en: 'in Givat Shmuel',   he: 'בגבעת שמואל' },
    'Zichron Yaakov':  { en: 'in Zichron Yaakov', he: 'בזכרון יעקב' },
    'Caesarea':        { en: 'in Caesarea',       he: 'בקיסריה' },
  }
